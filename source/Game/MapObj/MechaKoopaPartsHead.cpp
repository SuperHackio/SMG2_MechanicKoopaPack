...
void MechaKoopaPartsHead::init(const JMapInfoIter& rIter) {
    ...
    initInfo.setupEffect(NULL, 0);
    initInfo.setupSound(6, NULL);
...
void MechaKoopaPartsHead::exeDemoAppearStar() {
    if (MR::isFirstStep(this)) {
        //MR::startAfterBossBGM(); // Hell no lol
...
namespace NrvMechaKoopaPartsHead {
    MechaKoopaPartsHeadNrvWait(MechaKoopaPartsHeadNrvWait::sInstance);
    MechaKoopaPartsHeadNrvDemoBreak(MechaKoopaPartsHeadNrvDemoBreak::sInstance);
    MechaKoopaPartsHeadNrvDemoWhiteFadeOut(MechaKoopaPartsHeadNrvDemoWhiteFadeOut::sInstance);
    MechaKoopaPartsHeadNrvDemoWhiteWait(MechaKoopaPartsHeadNrvDemoWhiteWait::sInstance);
    MechaKoopaPartsHeadNrvDemoWhiteFadeIn(MechaKoopaPartsHeadNrvDemoWhiteFadeIn::sInstance);
    MechaKoopaPartsHeadNrvDemoAppearStar(MechaKoopaPartsHeadNrvDemoAppearStar::sInstance);
